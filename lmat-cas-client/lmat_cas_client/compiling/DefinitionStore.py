...
#
# TODO: reimplement caching if performance takes a significant hit.
# each definition should store its own cache for a corresponding definition store + a clear_cache method which takes the definition store which has been modified
# and thus which cache should be cleared.
...
class DefinitionStore:
    ...
    def override(self, new_definitions: dict[str, Definition]):
